    ...
    ui(new Ui::parametre)
{
    ...
    settings["save message"]="true";
    settings["notification sonore"]="true";
    settings["notification visuelle"]="true";
    settings["langage"]="francais";
}
...
{
    {
        if(arg1==tr("selectioner une musique","atention meme chose que dans l'ui la combo box de selection de musique")){
            settings["path"] = QFileDialog::getOpenFileName(this, tr("charger une musique"), nullptr , tr("fichier audio (*.MP3 *.WAV)"));
            if(settings["path"]==""){
                settings["path"] = ":/sound/notifdefault.wav";
            ...
            settings["path"] = ":/sound/Sonnerie_Ananta.wav";
