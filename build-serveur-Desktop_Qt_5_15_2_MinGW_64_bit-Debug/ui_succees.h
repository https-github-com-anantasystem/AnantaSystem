...
public:
    ...
    void setupUi(QDialog *sucees)
    {
        ...
        userdifferent10 = new QPushButton(groupBox);
        userdifferent10->setObjectName(QString::fromUtf8("userdifferent10"));
        userdifferent10->setFlat(true);

        gridLayout_2->addWidget(userdifferent10, 6, 2, 1, 1);
        ...
        gridLayout_2->addWidget(line, 2, 1, 8, 1);
    ...
    void retranslateUi(QDialog *sucees)
    {
        ...
        userdifferent10->setText(QCoreApplication::translate("sucees", "10 utilisateur connecter", nullptr));
#if QT_CONFIG(tooltip)
