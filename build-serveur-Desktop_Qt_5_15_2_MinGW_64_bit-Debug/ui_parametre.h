...
public:
    ...
    void retranslateUi(QDialog *parametre)
    {
        ...
        deletbuton->setText(QCoreApplication::translate("parametre", "suprimer tout les message enregistrer", nullptr));
        ...
        discord->setText(QCoreApplication::translate("parametre", "le discord (aide/bug)", nullptr));
